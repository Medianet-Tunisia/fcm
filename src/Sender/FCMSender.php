...
use MedianetFCM\Request\Request;
use MedianetFCM\Message\Options;
use MedianetFCM\Message\PayloadData;
use MedianetFCM\Response\GroupResponse;
use MedianetFCM\Response\TopicResponse;
use GuzzleHttp\Exception\ClientException;
use MedianetFCM\Response\DownstreamResponse;
use MedianetFCM\Message\PayloadNotification;
...
class FCMSender extends HTTPSender
{
     ...
     * @internal
     *
     * @param \MedianetFCM\Request\Request $request
     *
